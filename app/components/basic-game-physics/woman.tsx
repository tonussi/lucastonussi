...
import { useCharacterAnimations } from './contexts/character-anim'

const Woman = (props: PropsWithChildren) => {
  const group = useRef<THREE.Group>(null!)
  const { nodes, materials, animations } = useGLTF('/models/misc/woman/woman.gltf')
...
useGLTF.preload('/models/misc/woman/woman.gltf')
